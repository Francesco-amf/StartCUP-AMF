-- ==========================================
-- STARTCUP AMF - SISTEMA DE GERENCIAMENTO DE EVENTO
-- ==========================================
-- Este script cria as tabelas necessárias para gerenciar o evento completo
...
CREATE TABLE IF NOT EXISTS event_config (
  ...
  current_phase INTEGER DEFAULT 0, -- 0 = Preparação, 1-5 = Fases do evento
